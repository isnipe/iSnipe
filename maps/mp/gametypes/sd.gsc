...
////////////////////////////
//Custom SD gametype file///
//						 ///
//For iSnipe 2.* or higher//
//		By iNuke		////
////////////////////////////
...
onStartGameType()
{
	...
	setObjectiveText( game["attackers"], "Eliminate enemy snipers" );
	setObjectiveText( game["defenders"], "Eliminate enemy snipers" );
	...
	setObjectiveHintText( game["attackers"], "Eliminate enemy snipers" );
	setObjectiveHintText( game["defenders"], "Eliminate enemy snipers" );
